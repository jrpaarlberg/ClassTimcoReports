SELECT 
	purchase_order_item.po_id, 
    	purchase_order_item.line_nbr,
    	purchase_order_item.item_id, 
	purchase_order_item.item_desc, 
	purchase_order_item.item_cost, 
	purchase_order_item.requested_del_dt, 
    	purchase_order_item.supplier_item_nbr, 
   	purchase_order_item.ordered_qty, 
    	purchase_order_item.received_qty, 
    	purchase_order_item.item_tx, 
    	purchase_order_item.status_cd
   
FROM            
	purchase_order_item 
	
where purchase_order_item.po_id = 38857        
...
--	freight_FOB_desc.code_desc AS FrtFOBDesc,
--	comm_meth_desc.code_desc AS CommMthdDesc,
--	BuyAssociate.[assoc_nbr] AS BuyAssocName,
...
--LEFT OUTER JOIN
--	 code_desc AS freight_FOB_desc   
--	 ON freight_FOB_desc.code = PUR.fob_terms_cd
--	 AND freight_FOB_desc.field_nm = 'fob_terms_cd'
--LEFT OUTER JOIN
--	 code_desc AS freight_terms_desc   
--	 ON freight_terms_desc.code = PUR.freight_cd
--	 AND freight_terms_desc.field_nm = 'freight_cd' 
--LEFT OUTER JOIN
